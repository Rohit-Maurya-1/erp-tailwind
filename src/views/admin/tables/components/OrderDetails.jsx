      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        <div className="lg:col-span-1">
          <div className="space-y-4">
            <div className="card p-4 bg-gray-50 rounded-lg shadow-sm">
        ...
        <div className="lg:col-span-3 card p-4 bg-gray-50 rounded-lg shadow-sm">
              ...
              <tbody>
                {[...Array(4)].map((_, index) => (
                  <tr key={index} className="border-b">
                    <td className="p-2">
                      <select aria-label="Component select" className="border border-gray-300 rounded-md p-1">
                    ...
                    <td className="p-2">
                      <input type="number" defaultValue={1} min={0} className="border border-gray-300 rounded-md p-1" />
                    </td>
                    <td className="p-2">
                      <input type="number" step="0.01" min={0} className="border border-gray-300 rounded-md p-1" />
                    </td>
                    <td className="p-2">
                      <input type="number" step="0.01" min={0} className="border border-gray-300 rounded-md p-1" />
                    </td>
                    <td className="p-2">
                      <input type="number" step="0.01" min={0} readOnly className="border border-gray-300 rounded-md p-1" />
                    </td>
                    <td className="p-2">
                      <input type="number" defaultValue={0} min={0} className="border border-gray-300 rounded-md p-1" />
                    </td>
                  </tr>
                ))}
              </tbody>
